...
Dyslipidemia is a binary response outcome that is highly correlated with LDL and HDL cholesterol in the body. The results of the analysis reflect this, with the random forest model indicating that the ordinal LDL & HDL variable being the 2 biggest influencers of dyslipidemia classification respectively. The 3 models, with parameter tuning each achieved between 80-85% accuracy ahead of the $\approx$70% null accuracy, with Random Forests just beating out the other 2 by 1-2%. 
...
misClasificError <- mean(test_predictions_logit != test_diabetes$CVDMEDST)
print(paste('Accuracy: ',1-misClasificError))
