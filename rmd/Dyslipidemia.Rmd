...
We check the null accuracy, which is 69%. I am certain we can build a model to make substantial impovements on this baseline accuracy. 
...
print(paste("F1 score: ", F1_Score(test$CVDMEDST, test_predictions_logit, positive=0)))
