...
A positive correlation was noted between intake of carbohydrates with dyslipidemia, and trans fats be the highest indicator compared to polyunsaturated fats, monounsaturated fats, and saturated fats. Carbohydrates and trans fats were similarly positively correlated to diabetes, while other fats did not have as significant of a link. 
...
We now consider the relationships between our chosen factors. These factors were chosen based on expert knkowledge, but we plot a correlogram to look for multicollinearity which may cause problems in our models:
