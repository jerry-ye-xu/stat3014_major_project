...
table(test_diabetes$DIABBC, diabetes_true_test)
...
diabetes_true_test_rf <- predict(diabetes_train, data = test_diabetes)
table(test_diabetes$DIABBC, diabetes_true_test_rf$predictions)
